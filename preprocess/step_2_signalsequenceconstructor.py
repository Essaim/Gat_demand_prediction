...
def graph_sequence_construct(taxi_data, bike_data, taxi_node_list, bike_node_list,bike_node_list_drop, graph_path,xxx_path):
...
def main():
    ...
    bike_node_list.sort()
    _,__, bike_node_list_drop = bike_signal_sequence_construct(bike_data, bike_node_list, key='bike', path=bike_final_data,
                                   freq='30min')
    # print(bike_node_list_drop)
    print("bike signal finished.............................................")
    graph_sequence_construct(taxi_data, bike_data, taxi_node_list, bike_node_list,bike_node_list_drop, to_graph,xxx_path)
