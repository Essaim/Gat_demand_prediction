        ...
        for epoch in range(begin_epoch, begin_epoch + epochs):
            ...
            for phase in phases:
                ...
                for step, (inputs, targets) in tqdm_loader:
                    ...
                    running_loss[phase] = loss_calculate(outputs, targets, phase,node_num, loss_func)
                    steps += len(targets)

                    tqdm_loader.set_description(
                        f'{phase:5} epoch: {epoch:3}, {phase:5} loss: {running_loss[phase] / steps:3.6}   {normal_bike.running_loss[phase] / steps:3.6}')
